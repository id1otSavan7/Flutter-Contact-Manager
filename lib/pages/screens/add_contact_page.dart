            ...
            onPressedEvent: () {
              ...
              if (recipientPhoneNumber.text.isEmpty) {
                ...
                final contact = Contact(
                  recipientName:
                      isDataNull(recipientName.text, 'Unknown Recipient'),
                  recipientPhoneNumber: recipientPhoneNumber.text,
                  recipientEmailAddress: isDataNull(
                      recipientEmailAddress.text, 'No data recorded.'),
                  recipientAddress:
                      isDataNull(recipientAddress.text, 'No data recorded.'),
                  recipientRelation:
                      isDataNull(recipientRelation.text, 'No data recorded.'),
                );
                setState(() {
